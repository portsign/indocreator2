...
//	register_nav_menu('footer-menu','Footer Menu');
	...
	add_image_size('home-featured',575,290,true);
	add_image_size('home-blog',295,197,true);
	add_image_size('modern-archive',379,254,true);
	add_image_size('modern-blog',830,415,true);
...
if ( function_exists('register_sidebar') ) {
        ...
        register_sidebar(array(
                'name'=>'Homepage 1',
		'before_widget' => '<div class="wid_box_col">',
		'after_widget' => '</div>',
		'before_title' => '<h3>',
		'after_title' => '</h3>',
	));	
	 ...
	 register_sidebar(array(
                'name'=>'Homepage 3',
		'before_widget' => '<div class="wid_box_col wid_box_col_last">',
		'after_widget' => '</div>',
		'before_title' => '<h3>',
		'after_title' => '</h3>',
	));	
